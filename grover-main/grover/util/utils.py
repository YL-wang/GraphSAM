...
from grover.util.sam import SAM,GraphSAM
...
def build_optimizer(model: nn.Module, args: Namespace):
    ...
    if args.sam == 1:
        ...
        ], base_optimizer, lr=args.init_lr,  weight_decay=args.weight_decay)
        ...
        optimizer = GraphSAM([
            {'params': base_params, 'lr': args.init_lr * args.fine_tune_coff},
            {'params': ffn_params, 'lr': args.init_lr}
        ], base_optimizer, arg=args, lr=args.init_lr,  weight_decay=args.weight_decay)
    else:
        print('Adam')
